					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<ul class="breadcome-menu">
								...
								<li><span class="bread-blod">Customer Uploads</span></li>
							</ul>
						</div>
					</div>
				</div>
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="all-form-element-inner">
										<form action="customer_pp_upload" method="POST" enctype="multipart/form-data">
											<div class="row">
										...
										<br>
										<form action="customer_tc_uploads" method="POST" enctype="multipart/form-data">
											<div class="row">
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
													<div class="sparkline16-list responsive-mg-b-30">
														<div class="sparkline16-graph">
										...
										<br>
										<form action="customer_ug_uploads" method="POST" enctype="multipart/form-data">
											<div class="row">
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
													<div class="sparkline16-list responsive-mg-b-30">
														<div class="sparkline16-graph">
